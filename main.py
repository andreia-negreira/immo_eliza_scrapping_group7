...
for i in ["house"]: #, "apartment"
     ...
     for j in range(200,300):
        ...
        for page_url in pages_url:
           ...
           page_obj = session_object.get(page_url,verify=False)
...
with open("url_house300.txt", 'w') as url_house300:
   for i in url_all:
      url_house300.write(str(i) + '\n')
url_house300.close()
# opening the file in read mode
# my_file = open("url_house5.txt", "r")
#
# # reading the file
# data = my_file.read()
#
...
# # with open('url_houseAll.txt') as f:
# #    url_all = f.read().splitlines()
#
# for i in url_house_list5:
#     try:
#       req= requests.get(i)
...
#     except:
#       pass
#     element = soup.find('div', attrs={"class": "container-main-content"})
#     if element is not None and element.script is not None:
#           data = element.script.text
#           # Process the 'data' variable further as needed
#     else:
#           # Handle the case when the element or script tag was not found
#       pass  # Or any other default value or error handling mechanism you prefer
...
# df.to_csv('E:\\immo_eliza_scrapping_group7\\file2.csv')
#
